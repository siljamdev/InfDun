...
class MedkitParticle : Particle{
	
	static readonly Color3 col = new Color3("518E44");
	static readonly Color3 col2 = new Color3("B2BFAF");
	static readonly Color3 col3 = new Color3("4B5195");
